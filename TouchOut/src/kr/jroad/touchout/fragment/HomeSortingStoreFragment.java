...
public class HomeSortingStoreFragment extends Fragment {
	...
	public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
		...
		orderbySpinner = (Spinner) actionBarView
				.findViewById(R.id.orderby_spinner);
...
//		ft.commit();
		...
		Button btnBack = (Button) actionBarView.findViewById(R.id.back_btn);
		...
		orderbySpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				if (position == 0) {
					...
					// data 불러와서 selected true로 설정 -> 체크 보이게
					orderbyAdapter.setSelected(position);
